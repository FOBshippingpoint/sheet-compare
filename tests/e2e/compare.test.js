...
test("preview table shows spreadsheet indexes and freezes the first row and column", async () => {
  app = mount(App, { target: document.body });
...
test("diff table freeze handle supports keyboard and keeps action column pinned", async () => {
  app = mount(App, { target: document.body });
