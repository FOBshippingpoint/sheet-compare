 ...
 */
export function visibleRange(offset, viewportSize, itemSize, itemCount) {
...
export function columnWidth(rows, columnIndex, labelColumn = false) {
...
export function columnMetrics(widths) {
  const offsets = [0];
...
export function indexesForRange(range, frozenCount) {
 ...
 */
export function rangeNeedsUpdate(offset, viewportSize, range, offsets, guardItems) {
